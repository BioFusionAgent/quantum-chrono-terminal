...
/quantum-paradox-exploration
Example:
/quantum-paradox-exploration "Grandfather paradox analysis"
Description: Explore and analyze quantum paradoxes
...
`,
  ...
  '/quantum-paradox-exploration': (args: string) => handleCommand('paradox', args),
  ...
  '/connect': (args: string, onAgentConnect: (name: string, role: string) => void) => {
    ...
    return `Error: Unknown agent "${agentName}". Type /help to see available agents.`
  }
}
